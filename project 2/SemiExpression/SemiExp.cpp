...
bool SemiExp::GetStart(bool clear)
{
	bool temp = get(true);
	if (temp)
	{
...
bool SemiExp::isTerminator(Token token)
{
	...
	if (token == "\n")
	{
		trimFront();
		size_t s = find("#");
		if ((isFindPoundSign(_tokens)) && (_tokens[0] == "#"))
...
bool SemiExp::isCommentSemiExp( const Token& c_token)
{
	return _pToker->isCommentToken(c_token);
}
...
void SemiExp::setInitial(bool f, bool s)
{
	_pToker->setInitial(f, s);
}
//----< test stub >--------------------------------------------------
...
int main()
{
  ...
  /*std::string fileSpec1 = "../Test/special.txt";
  std::cout << "****************************************************************" << std::endl;
  ...
  std::cout << "****************************************************************" << std::endl;
  std::string fileSpec2 = "../Test/test_requirement7.txt";
  Test_Requirement7(fileSpec2);
*/
  std::cout << "****************************************************************" << std::endl;
  std::cout << "***********************Test Requirement 8***********************" << std::endl;
  std::cout << "****************************************************************" << std::endl;
  //std::string fileSpec3 = "../Test/test_requirement8.txt";
  std::string fileSpec3 = "../Test/test.txt";
