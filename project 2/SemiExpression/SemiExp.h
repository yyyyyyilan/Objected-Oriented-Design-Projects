...
* Maintenance History:
* --------------------
* ver 3.8 : 19 Feb 2016 by Yilan Li
* - Modified function bool isCommentSemiExp(Token c_token) to bool isCommentSemiExp(const Token& c_token)
...
namespace Scanner
{
  ...
  public:
	...
	bool isCommentSemiExp(const Token& c_token);
	void setInitial(bool f, bool s);
  private:
