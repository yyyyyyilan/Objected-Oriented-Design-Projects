...
* Maintenance History:
* --------------------
* ver 1.8 : 27 Apr 2016 by Yilan Li
* - add one virtual function in class AbstractXmlElement
*		virtual std::vector<std::pair<std::string, std::string>>&  attribute();
* ver 1.7 : 16 Mar 2015 by Jim Fawcett
* - added items to ToDo list
* ver 1.6 : 08 Mar 2015 by Jim Fawcett
* - added some more clarifying comments
* ver 1.5 : 22 Feb 2015 by Jim Fawcett
* - brought comments up to date
* ver 1.4 : 21 Feb 15 by Jim Fawcett
...
* ver 1.3 : 17 Feb 15 by Jim Fawcett
...
*   Thanks Scott!
* ver 1.2 : 14 Feb 15 by Jim Fawcett
...
namespace XmlProcessing
{
  ...
  inline std::vector<std::pair<std::string, std::string>>& AbstractXmlElement::attribute()
  { 
	  return attribs_; 
  }
  ...
  inline std::vector<std::pair<std::string, std::string>>& DocElement::attribute()
  {
	  return attribs_;
  }
  ...
  inline std::vector<std::pair<std::string, std::string>>& TextElement::attribute()
  {
	  return attribs_;
  }
  ...
  inline std::vector<std::pair<std::string, std::string>>& TaggedElement::attribute()
  {
	  return attribs_;
  }
  ...
  inline std::vector<std::pair<std::string, std::string>>& CommentElement::attribute()
  {
	  return attribs_;
  }
  ...
  inline std::vector<std::pair<std::string, std::string>>& ProcInstrElement::attribute()
  {
	  return attribs_;
  }
  ...
  inline std::vector<std::pair<std::string, std::string>>& XmlDeclarElement::attribute()
  {
	  return attribs_;
  }
